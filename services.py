...
class Service:
    def __init__(self, name, xpos, zpos, services, phone_number, tags):
        ...
        self.tags = tags
        self.summary = [[self.name], [f'Location : ({self.xpos}, {self.zpos})'], ['Services: ' + str(', '.join(map(str, self.services)))], [f'Phone Number: {self.phone_number}'], ['Tags: ' + str(', '.join(map(str, self.tags)))]]
...
Safeway.save()
Costco = Service('Costco', 4, 5, ['phones', 'PCs', 'laptops', 'groceries', 'TVs'], 3061112222, ['bulk', 'tech'])
Costco.save()